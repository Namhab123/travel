...
function init_SmartWizard() {
    ...
    $(".add-tours #wizard").smartWizard({
        onLeaveStep: function (obj, context) {
            ...
            if (startDate && endDate) {
                ...
                // Tính đúng số ngày: bao gồm cả ngày bắt đầu và kết thúc
                var daysDifference = Math.floor((endDateFormatted - startDateFormatted) / (1000 * 3600 * 24)) + 1;
            ...
            var regulatery = CKEDITOR.instances["regulatery"].getData();
            if (!regulatery) {
                isValid = false;
                toastr.error("Vui lòng điền mô tả!");
            }
    ...
    if ($("#myDropzone").length) {
        ...
        var myDropzone = new Dropzone("#myDropzone", {
            url: "http://Travel:8000/admin/add-images-tours",
            paramName: "image",
            maxFilesize: 5,
            acceptedFiles: "image/*",
            addRemoveLinks: true,

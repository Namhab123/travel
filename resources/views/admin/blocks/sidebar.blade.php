            ...
            <ul class=" navbar-right">
                ...
                <li role="presentation" class="nav-item dropdown open">
                    <a href="javascript:;" class="dropdown-toggle info-number" id="navbarDropdown1"
                        ...
                        <span class="badge bg-green">{{ $contactUnreadCount }}</span>
                    </a>
                ...
                <li role="presentation" class="nav-item dropdown open">
                    <a href="javascript:;" class="dropdown-toggle info-number" id="navbarDropdown1"
                        ...
                        <span class="badge bg-green">{{ $bookingUnreadCount }}</span>
                    </a>
                    <ul class="dropdown-menu list-unstyled msg_list" role="menu"
                        aria-labelledby="navbarDropdown1">
                        @foreach ($unreadBooking->take(3) as $item)
                            <li class="nav-item">
                                <a class="dropdown-item" href="{{ route('admin.booking') }}">
                                    <span>
                                        <h5>Có Tour đặt mới</h5>
                                        <b><span>{{ $item->tourId }}</span></b>
                                        <b><span>{{ $item->fullName }}</span></b>
                                        <span class="time">{{ $item->phoneNumber }}</span>
                                    </span>
                                </a>

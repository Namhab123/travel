                ...
                <div class="col-md-12 col-sm-12 ">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            {{-- <canvas id="lineChart" data-revenue-per-month="[31, 74, 6, 39, 20, 85, 7, 50, 60, 70, 80, 90]"></canvas> --}}
                        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const revenueData = JSON.parse(document.getElementById('lineChart').dataset.revenuePerMonth);

        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="section-title text-white text-center counter-text-wrap mb-70" data-aos="fade-up"
                    ...
                    <h2>Khám phá kho báu việt nam cùng Travel</h2>
            ...
            @foreach ($tours as $tour)
                <div class="col-xxl-3 col-xl-4 col-md-6" style="margin-bottom: 30px">
                    <div class="destination-item block_tours" data-aos="fade-up" data-aos-duration="1500"
                        data-aos-offset="50">
                        <div class="image">
                            <div class="rating"><?php echo isset($tour->average_rating) ? number_format($tour->average_rating) : 'N/A'; ?></div>
                        ...
                        <div class="content">
                            ...
                            <h5><a href="{{ route('tours_details', ['id' => $tour->tourId]) }}">{{ $tour->title }}</a>
                            </h5>
                        ...
                        <div class="destination-footer">
                            <span class="price"><span>{{ number_format($tour->priceAdult, 0, ',', '.') }}</span> VND /
                                người</span>
                            <a href="{{ route('tours_details', ['id' => $tour->tourId]) }}" class="read-more">Đặt ngay
        ...
        <!-- Nút Xem thêm -->
            <div class="text-center mt-4">
                <a href="{{ route('tours') }}" class="theme-btn style-two bgc-secondary">
                    <span data-hover="Xem thêm">Xem thêm</span>

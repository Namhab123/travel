        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="section-title text-white text-center counter-text-wrap mb-70" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <h2>Khám phá Việt Nam cùng Travel</h2>
                    <p>Đã có hơn <span class="count-text plus" data-speed="3000" data-stop="34500">0</span> người tin tưởng lựa chọn và đồng hành cùng chúng tôi</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
                ...
                <div class="col-xxl-3 col-xl-4 col-md-6">
                    <div class="destination-item block_tours" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        ...
                        <div class="content">
                            ...
                            <h5><a href="{{ route('tours_details',['id'=>$tour->tourId]) }}">{{ $tour->title }}</a></h5>
                            <span class="time">{{ $tour->time}}</span>
                        </div>
                        <div class="destination-footer">
                            <span class="price"><span>{{ number_format($tour->priceAdult,0,',','.') }}</span>VND/người</span>
                            <a href="{{ route('tours_details',['id'=>$tour->tourId]) }}" class="read-more">Đặt ngay <i class="fal fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
            @endforeach
            ...
            <div class="col-xl-5 col-lg-6">
                <div class="about-us-content rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                    <div class="section-title mb-25">
                        <h2>An Toàn - Thoải Mái - Tiết Kiệm
                            Những lý do hàng đầu để lựa chọn công ty chúng tôi
                        </h2>
                    </div>
                    <p>Chúng tôi đồng hành và hỗ trợ để giúp bạn được đi, được trải nghiệm, được tận hưởng,... đưa bạn đến những
                        nơi đáng đến, đáng dừng chân - không ồn ào, không đại trà, chỉ đơn giản là đúng chất và đáng nhớ.
                        
                    </p>
                    <div class="divider counter-text-wrap mt-45 mb-55"><span>Chúng tôi có <span><span class="count-text plus" data-speed="3000" data-stop="10">0</span> Năm</span> kinh nghiệm</span></div>
                    <div class="row">
                        <div class="col-6">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="section-title text-center counter-text-wrap mb-70" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        ...
                        <p>Trang web với <span class="count-text plus" data-speed="3000" data-stop="34500">0</span> lượt trải nghiệm và đánh giá tích cực</p>
                    </div>
                </div>
            </div>
            <div class="container">
            ...
            <div class="col-xl-6">
                <div class="features-content-part mb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                    <div class="section-title mb-60">
                        <h2>Các tính năng trải nghiệm du lịch mới lạ, tối ưu giúp công ty chúng tôi trở nên khác biệt</h2>
                    </div>
                    <div class="features-customer-box">
                        ...
                        <div class="content">
                            ...
                            <h6>Với 850K+ khách hàng hài lòng</h6>
                            <div class="divider style-two counter-text-wrap my-25"><span><span class="count-text plus" data-speed="3000" data-stop="10">0</span> Năm</span></div>
                            <p>Chúng tôi tự hào cung cấp những chuyến đi, địa điểm phù hợp với từng khách hàng</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row pb-25">
                    <div class="col-md-6">
                        <div class="feature-item">
                            ...
                            <div class="content">
                                <h5><a href="{{route('tours')}}">Cắm trại ngoài trời</a></h5>
                                <p>Cắm trại ngoài trời là cách tuyệt vời nhất để hòa mình với thiên nhiên</p>
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="icon"><i class="flaticon-tent"></i></div>
                            <div class="content">
                                ...
                                <p>Chèo thuyền Kayak là môn thể thao thú vị và đầy mạo hiểm </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="feature-item mt-20">
                            <div class="icon"><i class="flaticon-tent"></i></div>
                            <div class="content">
                                <h5><a href="{{route('tours')}}">Đạp xe trên núi</a></h5>
                                <p>Đi xe đạp trên núi là môn thể thao giúp rèn luyện sức khỏe nhưng cũng đầy thử thách</p>
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="icon"><i class="flaticon-tent"></i></div>
                            <div class="content">
                                <h5><a href="{{route('tours')}}">Câu cá trên thuyền</a></h5>
                                <p>Hoạt động đòi hỏi tính kiên nhẫn nhưng cũng giúp chung ta thư giãn và thoải mái</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-duration="1500" data-aos-offset="50">
                <div class="cta-item" style="background-image: url({{  asset('clients/assets/images/cta/cta1.jpg')}});">
                    <span class="category">Cắm trại ngoài trời </span>
                    <h2>Những hoạt động thú vị và thư giãn</h2>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="blog-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <div class="content">
                        ...
                        <h5><a href="blog-details.html">Ultimate Guide to Planning Your Dream Vacation with Travel Travel Agency</a></h5>
                        <ul class="blog-meta">

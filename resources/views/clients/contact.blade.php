                ...
                <div class="row">
                        ...
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50"
                            ...
                            <div class="content">
                                ...
                                <div class="text"><i class="far fa-envelope"></i> <a
                                        href="mailto:manh8h@gmail.com">manh8h@gmail.com</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50"
                            ...
                            <div class="content">
                                <h5>Hà Nội</h5>
                                <div class="text"><i class="fal fa-map-marker-alt"></i> Trâu Quỳ, Gia Lâm, Hà Nội</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50"
                            ...
                            <div class="content">
                                <h5>Hà Tĩnh</h5>
                                <div class="text"><i class="fal fa-map-marker-alt"></i> Thạch Hà, Hà Tĩnh</div>
                            </div>
                        </div>
                    </div>
                </div>

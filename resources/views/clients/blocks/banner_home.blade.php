...
<section class="hero-area bgc-black pt-200 rpt-120 rel z-2">
    <div class="container-fluid">
        <h1 class="hero-title" data-aos="flip-up" data-aos-delay="50" data-aos-duration="2000" data-aos-offset="50">Du lịch &
            Khám phá</h1>
        ...
        <div class="container container-1400">
            <div class="search-filter-inner" data-aos="zoom-out-down" data-aos-duration="1500" data-aos-offset="50">
                ...
                <div class="filter-item clearfix">
                    ...
                    <input type="date" id="start_date" name="start_date" class="form-control" placeholder="Chọn ngày đi">
                ...
                <div class="filter-item clearfix">
                    ...
                    <input type="date" id="end_date" name="end_date" class="form-control" placeholder="Chọn ngày về">

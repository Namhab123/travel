                    ...
                    <nav class="main-menu navbar-expand-lg">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown {{ in_array(Request::url(), [route('tours'), route('tours_guide').  route('tours_details')]) ? 'active' : '' }}">
                                    <a href="#">Tours</a>
                                    <ul>
                    ...
                    <div class="menu-sidebar">
                        <li class="drop-down">
                                <button class="dropdown-toggle bg-transparent" id="userDropdown" style="color: #f3f3f7">
                                    <i class="fa-solid fa-user fa-flip fa-2xl" style="color: #f3f3f7;"></i>                        
                                </button>

...
<body>
    @if (session('message'))
    <script>
        toastr.success('{{ session('message') }}', 'Thông báo');
    </script>
@endif
                ...
                <div class="container">
                    <div class="signin-content">
                        <div class="signin-image">
                            ...
                            <a href="javascript:void(0)" class="signup-image-link" id="sign-up">Tạo 1 tài khoản mới</a>
                        </div>
...
<body>
    ...
    <div class="login-template">
        <!-- Tiếp tục phần còn lại của file mn.txt -->
            <!-- Sign up form -->
                    ...
                    <div class="signup-content">
                        <div class="signup-form">
                            ...
                            <form action="{{ route('register') }}" method="POST" class="register-form"
                                id="register-form" style="margin-top: 15px">
                                <div class="form-group">
                                ...
                                <div class="invalid-feedback" style="margin-top:-15px" id="validate_username_regis">
                                </div>
                                @csrf
                                <div class="form-group">
                                ...
                                <div class="invalid-feedback" style="margin-top:-15px" id="validate_password_regis">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="signup-image">
                            <figure><img src="{{ asset('clients/assets/images/login/signup-image.png') }}"
                                    alt="sing up image"></figure>
                            <a href="javascript:void(0)" class="signup-image-link" id="sign-in">Tôi đã có tài khoản
                                rồi</a>
                        </div>
                    </div>
                </div>

        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-10 rmb-75">
                <div class="shop-sidebar">
                    <div class="div-filter-clear">
                        <button class="clear-filter" name="btn-clear">Clear</button>
                    </div>
                    ...
                    <div class="widget widget-activity" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        ...
                        <ul class="radio-filter">
                            <li>
                                ...
                                <label for="mien_bac">Miền Bắc <span>{{ $domainCount['mien_bac'] }}</span></label>   
                            </li>
                            <li>
                                <input class="form-check-input" type="radio" name="domain" id="id_mien_trung" value="t">
                                <label for="id_mien_trung">Miền Trung <span>{{ $domainCount['mien_trung'] }}</span></label>
                            </li>
                            <li>
                                <input class="form-check-input" type="radio" name="domain" id="id_mien_nam" value="n">
                                <label for="id_mien_nam">Miền Nam <span>{{ $domainCount['mien_nam'] }}</span></label>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-9">
                ...
                <div class="tour-grid-wrap">
                    ...
                    <div class="row" id="tours-container">
                        @include('clients.partials.filter-tours', ['filterTours' => $tours]) 
                        <div class="col-lg-12">
